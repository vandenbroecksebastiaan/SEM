...
\multirow{2}{*}{Harm avoidance}     & SE8                            & \multicolumn{1}{l|}{335}                  & 270       \\ \cline{2-4} 
                                    & SE9                            & \multicolumn{1}{l|}{276}                  & 329       \\ \hline
\end{tabular}
}
\end{minipage}
\end{table}
...
PA63              & 1.000            & /                       &  /               & /                    & 0.850 \hfill ($\lambda_{y_{1,1}}$)  &  0.722               & 0.278 \hfill ($\epsilon_1$)  \\ \hline
PA64              & 0.631            & 0.073                   &  8.662           & \textless 0.001      & 0.536 \hfill ($\lambda_{y_{2,1}}$)  &  0.287               & 0.713 \hfill ($\epsilon_2$)  \\ \hline
PA65              & 0.198            & 0.047                   &  4.236           & \textless 0.001      & 0.168 \hfill ($\lambda_{y_{3,1}}$)  &  0.028               & 0.972 \hfill ($\epsilon_3$)  \\ \hline
PA66              & 0.071            & 0.048                   &  1.492           & 0.136                & 0.061 \hfill ($\lambda_{y_{4,1}}$)  &  0.004               & 0.996 \hfill ($\epsilon_4$)  \\ \hline
PA67              & 0.646            & 0.066                   &  9.757           & \textless 0.001      & 0.548 \hfill ($\lambda_{y_{5,1}}$)  &  0.301               & 0.699 \hfill ($\epsilon_5$)  \\ \hline
PA68              & 0.890            & 0.078                   & 11.460           & \textless 0.001      & 0.757 \hfill ($\lambda_{y_{6,1}}$)  &  0.572               & 0.428 \hfill ($\epsilon_6$)  \\ \hline
PA69              & 0.360            & 0.051                   &  7.005           & \textless 0.001      & 0.306 \hfill ($\lambda_{y_{7,1}}$)  &  0.094               & 0.906 \hfill ($\epsilon_7$)  \\ \hline
%                                                                                                                                
SE7V              & 1.000            & /                       &  /               & /                    & 0.602 \hfill ($\lambda_{x_{1,1}}$)  &  0.362               & 0.637 \hfill ($\delta_1$)  \\ \hline
SE7D              & 1.203            & 0.160                   &  7.504           & \textless 0.001      & 0.724 \hfill ($\lambda_{x_{2,1}}$)  &  0.525               & 0.475 \hfill ($\delta_2$)  \\ \hline
...
$\gamma_{2,1}$     &  -0.161 \hfill       & -0.172                      & 0.033                   &  -4.824          & \textless 0.001  \\ \hline
$\gamma_{2,2}$     &  -0.376 \hfill       & -0.548                      & 0.024                   &  -15.948         & \textless 0.001  \\ \hline
$\beta_{1,2}$      &   0.206 \hfill       &  0.136                      & 0.064                   &   3.214          & 0.001            \\ \hline
$\gamma_{1,2}$     &  -0.442 \hfill       & -0.427                      & 0.056                   &  -7.956          & \textless 0.001  \\ \hline
\end{tabular}
}
\end{table}
